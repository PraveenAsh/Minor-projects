...
const byte Output[rows]={0,1,2,3}; //array of pins used as output for rows of keypad
const byte Input[columns]={5,6,7,8}; //array of pins used as input for columnss of keypad
